  ...
  return (
    <div className="detail">
      ...
      <div>
        ...
        　現在は自分の中にある「何かを改善するためのアイデア」を実際に形にし、自分がこれまで感じてきた不便を解決し多くの人に価値を提供するための手段として、プログラミング学習に励んでいます。</p>
      </div>
      
      <div>
        <h4 className="aboutPage-title">- 略歴 -</h4>
        <p className="career">
        2007.04 - 2009.03　岩手県立宮古高等学校 卒業<br/>
        2009.04 - 2011.03　国立山形大学 工学部 応用生命システム工学科 中退<br/>
        2011.04 - 2013.03　専門学校ミューズ音楽院 ミキシングクリエーター専攻 卒業<br/>
        2013.03 - 2015.04　音楽活動（リリース、ワンマンライブ、東名阪ツアーなどを行う）<br/>
        2015.05 - 2015.10　株式会社あとらす二十一 （Webディレクター）<br/>
